...
namespace V___Medicals.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        /// </summary>
        [BindProperty]
        public ValidationModels.LoginModel login { get; set; }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                     var IsAdmin = await _userManager.IsInRoleAsync(user, Constants.Constants.ROLE_ADMIN);
                     if (!IsAdmin)
                      {
                        await _signInManager.SignOutAsync();
                        ModelState.AddModelError(string.Empty, "You're not allowed to sign-in on web portal!");
                     return Page();
